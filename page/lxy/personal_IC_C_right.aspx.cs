...
public partial class page_lxy_personal_IC_C_right : System.Web.UI.Page
{
    int id = 6;
    ...
    public void getdata(int pagenum)
    {
        ...
        DataSet dsr, dsu;
        dsr = data.query("select mandatory from RewardRelationship WHERE client = '" + client + "' AND lno = '" + lno + "'");
        ...
        {
            dsu = data.query("select uname, uphone from UserInformation WHERE uid = '" + Convert.ToInt32(dsr.Tables["base"].Rows[i]["mandatory"].ToString()) + "'");
            if (num >= 6)
            {
                break;
            }
    ...
    {
        Response.Redirect("personal_IC_C_right.aspx?pagenum=1");
    }
    ...
    protected void LastPage_Click(object sender, EventArgs e)
    {
        ...
        {
            pagecurrent--;
            string url_right = "personal_IC_C_right.aspx?pagenum=" + pagecurrent.ToString();
