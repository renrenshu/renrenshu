<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal_IC_M_right.aspx.cs" Inherits="page_lxy_personal_IC_M_right" %>
     ...
     <asp:Panel ID="Panel1" runat="server">
            <asp:Panel ID="add_book" runat="server">
                <asp:Panel ID="title_div" runat="server">
                    <asp:Label ID="title_lab" runat="server" Text="修改悬赏信息"></asp:Label>
                </asp:Panel>
