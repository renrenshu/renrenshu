...
public partial class page_lxy_personal_IB_C_right : System.Web.UI.Page
{
    int id = 6;
    ...
    public void getdata(int pagenum)
    {
        ...
        DataSet dso, dsu;
        dso = data.query("select seller from OrderRelationship WHERE buyer = '" + buyer + "' AND bno = '" + bno + "'");
        ...
        {
            dsu = data.query("select uname, uphone from UserInformation WHERE uid = '" + Convert.ToInt32(dso.Tables["base"].Rows[i]["seller"].ToString()) + "'");
            if (num >= 6)
            {
                break;
            }
    ...
    {
        Response.Redirect("personal_IB_C_right.aspx?pagenum=1");
    }
    ...
    protected void LastPage_Click(object sender, EventArgs e)
    {
        ...
        {
            pagecurrent--;
            string url_right = "personal_IB_C_right.aspx?pagenum=" + pagecurrent.ToString();
