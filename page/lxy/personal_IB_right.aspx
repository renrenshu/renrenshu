<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal_IB_right.aspx.cs" Inherits="page_lxy_personal_IB_right" %>
    ...
    <script id="gooods-item" type="text/x-jquery-tmpl">
        ...
        <div class="col-lg-4 book_div">
            ...
            <asp:Panel ID="Panel2" runat="server">
                &nbsp;<a href="personal_IB_C_right.aspx?buyer=${ buyer }&bno=${ bno }" target="_right"  class="check">查看订阅详情>>></a>
            </asp:Panel>
