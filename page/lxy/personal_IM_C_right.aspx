<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal_IM_C_right.aspx.cs" Inherits="page_lxy_personal_IM_C_right" %>
    ...
    <table style="height: 80%; width: 100%;">
        <tr>
            ...
            <td class="auto-style3">
                <asp:Label ID="Label1" CssClass="ordertable" runat="server" Text="卖家用户名" Width="100%"></asp:Label>
            </td>
            <td class="auto-style2">
                <asp:Label ID="Label2" CssClass="ordertable" runat="server" Text="卖家手机号码" Width="100%"></asp:Label>
            </td>
            <td></td>
        </tr>
        <tr>
