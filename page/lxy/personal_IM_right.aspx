<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal_IM_right.aspx.cs" Inherits="page_lxy_personal_IM_right" %>
    ...
    <script id="gooods-item" type="text/x-jquery-tmpl">
        ...
        <div class="col-lg-4 book_div">
            ...
            <asp:Panel ID="Panel2" runat="server">
                &nbsp;<a href="personal_IM_C_right.aspx?mandatory=${ mandatory }&lno=${ lno }" target="_right"  class="check">查看订阅详情>>></a>
            </asp:Panel>
            ...
            <asp:Panel ID="Panel4" runat="server">
                <a href="personal_IM_D_right.aspx?mandatory=${ mandatory }&lno=${ lno }" target="_right"  class="check">取消揭榜</a>
