            ...
            <div id="menu">
                ...
                <asp:Table ID="menutab" runat="server" BorderStyle="None" Height="30px">
                    <asp:TableRow runat="server">
                        <asp:TableCell cssclass="menu_a" runat="server" Height="30px" Width="50px"><a href="../yw/index.aspx" target ="_parent">首页</a></asp:TableCell>
                        <asp:TableCell cssclass="menu_a" runat="server" Height="30px" Width="50px"><a href="../yw/book.html" target ="_parent">书库</a></asp:TableCell>
