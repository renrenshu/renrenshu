<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal_IC_right.aspx.cs" Inherits="page_lxy_personal_IC_right" %>
    ...
    <script id="gooods-item" type="text/x-jquery-tmpl">
        ...
        <div class="col-lg-4 book_div">
            ...
            <asp:Panel ID="Panel2" runat="server">
                &nbsp;<a href="personal_IC_C_right.aspx?client=${ client }&lno=${ lno }" target="_right"  class="check">查看揭榜详情>>></a>
            </asp:Panel>
            ...
            <asp:Panel ID="Panel6" runat="server">
                <a href="personal_IC_D_right.aspx?client=${ client }&lno=${ lno }" target="_right"  class="check">删除悬赏</a>
                <asp:Label ID="Label11" CssClass="jiage" runat="server" Text="价格">${ offer }元</asp:Label>
            </asp:Panel>
            <asp:Panel ID="Panel4" runat="server">
                <a href="personal_IC_M_right.aspx?lno=${ lno }" target="_right"  class="check">修改发布悬赏信息</a>
